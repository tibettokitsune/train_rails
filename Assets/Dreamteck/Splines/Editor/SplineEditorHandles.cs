namespace Dreamteck.Splines.Editor
{
    ...
    public static class SplineEditorHandles
    {
        ...
        {
            var fmh_48_53_638559894827137190 = Quaternion.identity; return Handles.FreeMoveHandle(position, size, Vector3.zero, Handles.CircleHandleCap);
        }

        public static Vector3 FreeMoveCircle(Vector3 position, float size)
        {
            var fmh_53_53_638559894827153090 = Quaternion.identity; return Handles.FreeMoveHandle(position, size, Vector3.zero, Handles.CircleHandleCap);
        }
